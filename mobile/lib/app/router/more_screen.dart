...
final _items = [
  _MoreItem(label: 'Analytics', icon: Icons.bar_chart_rounded, requires: 'viewAnalytics', screenBuilder: (_) => const ComingSoonScreen(title: 'Analytics')),
  ...
  _MoreItem(label: 'Client Reports', icon: Icons.description_outlined, requires: 'exportData', screenBuilder: (_) => const ComingSoonScreen(title: 'Client Reports')),
  _MoreItem(label: 'Messages', icon: Icons.chat_bubble_outline_rounded, screenBuilder: (_) => const MessagesListScreen()),
  _MoreItem(label: 'Settings', icon: Icons.settings_outlined, screenBuilder: (_) => const ComingSoonScreen(title: 'Settings')),
];
        ...
        children: [
          ...
          if (user?.isAdmin ?? false)
            ListTile(
              ...
              trailing: const Icon(Icons.chevron_right_rounded, color: AppColors.slate300),
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ComingSoonScreen(title: 'Admin Panel'))),
            ),
          ...
          ListTile(
            ...
            trailing: const Icon(Icons.chevron_right_rounded, color: AppColors.slate300),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ComingSoonScreen(title: 'Profile'))),
          ),
          ListTile(
