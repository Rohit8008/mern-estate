    ...
    <article className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
      {images.length > 0 ? (
        ...
        <div className="aspect-[16/10] bg-slate-100 flex items-center justify-center">
          <span className="text-sm text-slate-600">{t('sharedProperties.noPhotos')}</span>
        </div>
      )}
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
        ...
        >
          ...
          <label htmlFor="share-passcode" className="sr-only">{t('sharedProperties.passcode')}</label>
          <input
            id="share-passcode"
            autoFocus
            autoComplete="off"
            ...
            className="w-full mt-4 border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-slate-900"
