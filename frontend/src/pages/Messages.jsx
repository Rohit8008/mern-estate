  ...
  return (
    <div className='space-y-5'>
      <PageHeader
        ...
        actions={
          <Button variant='primary' size='sm' icon={HiPlus} onClick={() => setShowNewChat(true)}>{t('messages.newMessage')}</Button>
        }
      />
          ...
          <div className='bg-white rounded-xl shadow-2xl w-full max-w-md mx-4' onClick={(e) => e.stopPropagation()}>
            ...
            <div className='p-4'>
              ...
              <div className='mt-3 max-h-72 overflow-y-auto'>
                {searching && <p className='text-sm text-slate-500 text-center py-4'>{t('messages.searching')}</p>}
